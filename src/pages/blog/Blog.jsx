...
const Blog = () => {
  return (
    <div className="py-20 flex flex-col items-center justify-center lg:w-11/12 mx-auto">
        {/* blog 1 */}
      <section class="">
          ...
          <div class="lg:flex lg:-mx-6">
            <div class="lg:w-3/4 lg:px-6">
              <img
                ...
                src="https://media.gettyimages.com/id/1290904409/photo/abstract-digital-news-concept.jpg?s=612x612&w=gi&k=20&c=KLjgxFfLQpBQVw9h4lBcJyyfKzHkrpRJOq6wO8mMv0M="
              ...
              <div>
                ...
                <h1 class="capitalize max-w-lg mt-4 text-2xl font-semibold leading-tight text-gray-800 dark:text-white">
        ...
        <div class="container px-6 py-10 mx-auto">
          <div class="lg:flex lg:-mx-6">
            <div class="lg:w-3/4 lg:px-6">
              <img
                class="object-cover object-center w-full h-80 xl:h-[28rem] rounded-xl"
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS2Mkh6JrQEpKM9cEdINhIEo8c-SJYPr8nGQQ&s"
                alt=""
              />
              ...
              <div>
                ...
                <div class="flex items-center mt-6">
                  <img
                    class="object-cover object-center w-10 h-10 rounded-full"
                    src="https://assets.unileversolutions.com/v1/134103152.jpg"
                    alt=""
                  />
